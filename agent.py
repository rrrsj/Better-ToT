...
def get_gpt_output(question,parent):
    ...
    data = f'{{"prompt":"{question}","parentMessageId":"{parent}","persona_id":"","options":{{"model":"gpt-3.5-turbo","temperature":0.8,"presence_penalty":0,"frequency_penalty":0,"max_tokens":1888}}}}'
    #print(data)
